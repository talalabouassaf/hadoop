...
public class job4{
	 ...
	 @SuppressWarnings({ "deprecation", "resource" })
	    ...
	    String targetTable = setting.getId()+":query4";
	    ...
	    TableMapReduceUtil.initTableMapperJob(sourceTable, scan, map4.class, Text.class, Text.class, job);
	    TableMapReduceUtil.initTableReducerJob(targetTable,reducer4.class,job);
