...
public class job2{
	...
	String targetTable = setting.getId()+":query2";
	...
	TableMapReduceUtil.initTableMapperJob(sourceTable, new Scan(), map2.class, Text.class, Text.class, job);
	TableMapReduceUtil.initTableReducerJob(targetTable,reducer2.class,job);
